package com.deveint.user.Fragments;
...
import com.deveint.user.Activities.CustomGooglePlacesSearch;
import com.deveint.user.Activities.HistoryActivity;
import com.deveint.user.Activities.LocationAndGoodsActivity;
import com.deveint.user.Activities.ShowProfile;
import com.deveint.user.Adapter.StatusAdapter;
import com.deveint.user.CellMoveApplication;
import com.deveint.user.Helper.*;
import com.deveint.user.Models.CardInfo;
import com.deveint.user.Models.Driver;
import com.deveint.user.Models.Locations;
import com.deveint.user.Models.TripStatus;
import com.deveint.user.R;
import com.deveint.user.Retrofit.ApiInterface;
import com.deveint.user.Retrofit.ResponseListener;
import com.deveint.user.Retrofit.RetrofitClient;
import com.deveint.user.Utils.MapAnimator;
import com.deveint.user.Utils.MyBoldTextView;
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(),
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setMessage("This user needs the Location permission, please accept to use location functionality")
...
//                            frmSource.setText(source_address);
    ...
    public void getServiceList() {
        ...
        try {
            ...
            CellMoveApplication.getInstance().addToRequestQueue(jsonArrayRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
//                            }
    ...
    public void sendRequest() {
        ...
        if (customDialog != null)
            customDialog.show();
        System.out.println("RRR SEND_REQUEST_API = " + URLHelper.SEND_REQUEST_API);

        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST,
                URLHelper.SEND_REQUEST_API, new Response.Listener<NetworkResponse>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (response != null && response.data != null) {
                    ...
                    if (error instanceof NoConnectionError) {
                        ...
                        displayMessage(context.getResources().getString(R.string.oops_connect_your_internet));
                    } else if (error instanceof TimeoutError) sendRequest();
                }
            }
        }) {
            @Override
            public Map<String, String> getParams() {
                ...
                try {
                    ...
                    try {
                        ...
                        if (chkWallet.isChecked()) params.put("use_wallet", "1");
                        else params.put("use_wallet", "0");
        ...
        CellMoveApplication.getInstance().addToRequestQueue(volleyMultipartRequest);
    }
...
//                    destination.setText(SharedHelper.getKey(context, "extend_address"));
    ...
    private String getDirectionsUrl(LatLng sourceLatLng, LatLng destLatLng) {
        ...
        Utilities.print("url", url);
        return url;

    }

    private void showChooser() {
        Intent intent = new Intent(getActivity(), com.deveint.user.Activities.Payment.class);
...
//                            frmSource.setText(source_address);
    ...
    private void setupRecyclerView() {
        ...
        if (statusAdapter == null) {
            statusAdapter = new StatusAdapter(statusArrayList, context);
    ...
    private class ServiceListAdapter extends RecyclerView.Adapter<ServiceListAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(ServiceListAdapter.MyViewHolder holder, final int position) {
            Utilities.print("Title: ", "" + jsonArray.optJSONObject(position).optString("name") + " Image: " + jsonArray.optJSONObject(position).optString("image") + " Grey_Image:" + jsonArray.optJSONObject(position).optString("grey_image"));
