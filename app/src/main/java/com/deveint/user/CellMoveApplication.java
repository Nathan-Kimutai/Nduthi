...
import com.deveint.user.Helper.LocaleUtils;
...
public class CellMoveApplication extends Application {

    public static final String TAG = CellMoveApplication.class
            .getSimpleName();

    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;

    private static CellMoveApplication mInstance;
    ...
    public static synchronized CellMoveApplication getInstance() {
        return mInstance;
    }
